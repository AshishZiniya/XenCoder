...
const SidebarItem: React.FC<SidebarItemProps> = ({ href, icon, label, active = false }) => {
...
export const Sidebar: React.FC<SidebarProps> = ({ children, className }) => {
  return (
    <aside className={cn('w-64 bg-[#1e293b] border-r border-slate-700 flex flex-col', className)}>
      {/* Logo */}
      <div className="p-6 flex items-center gap-3">
        <div className="w-8 h-8 bg-blue-500 rounded flex items-center justify-center">
          <span className="font-bold text-xl text-white">X</span>
        </div>
        <h1 className="text-xl font-bold tracking-tight text-white">Xencoder</h1>
      </div>
